...
<style>
    .text_box, .select2-container--default .select2-selection--multiple
    {
        border: unset;
        padding: 3px 0px;
    }
    .parent_time_sheet table tr td:first-child
    {
        width: 220px;
    }
</style>
<body>
        ...
        <main class="home">
                ...
                <div class="navbar-contens">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Teacher List</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-profile-tab" data-toggle="pill" data-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Teacher Mapping</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-contact-tab" data-toggle="pill" data-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Resigned List</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="titel_conts">
                                ...
                                <div>
                                    <button class="year_btn" onclick="teacher_view()"><img src="{{ asset('School/asset/icons/add teacher.svg') }}">Add Teacher</button>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div class="titel_conts">
                                <div class="">
                                    <div class="academic_text">
                                        <h4>Teacher Mapping</h4>
                                        <p>Total Teachers - 345</p>
                                    </div>
                                    <!-- <div class="select_addemics_con">
                                        <div class="select_contern">
                                            <p>Academic Year</p>
                                ...
                                <div>
                                    <button class="year_btn" data-toggle="modal" data-target="#map_teacher"><img src="{{ asset('School/asset/icons/add teacher.svg') }}">Map Teacher</button>
                                </div>
                            </div>
                            <div class="main_table">
                                <table class="display data--table" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>English, Maths</td>
                                            <td>16 May 2022</td>
                                            <td class="edit_text" data-toggle="modal" data-target="#edit_map_teacher"><img src="{{ asset('School/asset/edit.png') }}"><a href="#">Edit</a></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>AT002</td>
                        ...
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <div class="titel_conts">
                                ...
                                <!--     <div>
                                    <button class="year_btn" data-toggle="modal" data-target="#exampleModal"><img src="asset/icons/add teacher.svg">Map Teacher</button>
                                </div>  -->
                            </div>
                            <div class="main_table">
                                <table class="display data--table" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Female</td>
                                            <td>16 May 2022</td>
                                            <td>tamekku@ac.com</td>
                                            <td>(312)946-5086</td>
                                             <td>16 May 2022</td>
                                            <td class="edit_text" onclick="student()"><img src="{{ asset('School/asset/icons/view.svg') }}"><a href="#">View</a></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>AT002</td>
            ...
            <div class="hidden" id="student_views">
                <div>
                    <ul class="breadcrumb-set">
                        <li><a href="#" class="">Teacher Management</a> /</li>
                        <li><a href="#" class="">Ophelia Howard</a></li>
                ...
                <div class="set-time-table">
                    <div style="display: flex; gap:10px;">
                        ...
                        <div>
                            <h4>Ophelia Howard</h4>
                            <p>TC001</p>
                        </div>
                    </div>
                <div><button class="cancel_btns" data-toggle="modal" data-target="#exampleModal"><img src="asset/cancel.png">Disable Teacher</button>
                        <button class="edit_stu" onclick="edit_teacher_view()"><img src="{{ asset('School/asset/edites.png') }}">Edit Teacher</button>
                    </div>
                </div>
                       <div class="main_tables">
                    <div class="profile_contents">
                        <img src="{{ asset('School/asset/ophelia.png') }}">
                        <div class="">
                            <div class="profile_details">
                                <h6>Ophelia Howard</h6>
                                    ...
                                    <tbody>
                                     ...
                                     <!--    <tr>
                                        ...
                                        <tr>
                                            <td>Email</td>
                                            <td>-</td>
                                            <td><span>wille98@gmail.com</span></td>
                                        </tr>
                                        <tr>
                                            <td>Address</td>
                                            <td>-</td>
                    ...
                    <div class="parent_details_bg">
                        ...
                        <div class="parent_time_sheet">
                            <table class="">
                                <tbody>
                                    <tr>
                                        <td>Father's Name</td>
                                        <td>-</td>
                                        <td><span>Edward Davidon</span></td>
                                    </tr>
                                    <tr>
                                        <td>Mother's Name</td>
                                        <td>-</td>
                                        <td><span>Elizabeth Barrett</span></td>
                                    </tr>
                                    <tr>
                                        <td>Nationality</td>
                                        <td>-</td>
                            ...
                            <table class="boder_top" style="height: 20px;">
                                <tbody>
                                    <tr>
                                        <td>Father's Occupation</td>
                                        <td>-</td>
                                        <td><span>Business Owner</span></td>
                                    </tr>
                                    <tr>
                                        <td>Mother's Occupation</td>
                                        <td>-</td>
                                        <td><span>Accountant</span></td>
                                    </tr>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>-</td>
                                        <td><span>June 2015</span></td>
                                    </tr>
                                    <tr>
                                        <td>School / College / University</td>
                                        <td>-</td>
                                        <td><span>Madras University</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                 ...
                 <div class="reject   class_detail">
                        <div class="reject_reason">
                            <h6>Disabled Reason</h6>
                        </div>
                        <div class="reject_reason_sub_text">
                            <h4>Job Relocation</h4>
            ...
            <div class="hidden" id="student">
                ...
                <div class="set-time-table">
                    <div style="display: flex; gap:10px;">
                        <div class="left_arrows">
                             <img src="{{ asset('School/asset/img/arrow.png') }}" onclick="student()">
                        </div>
                   ...
                   <!--  <div><button class="cancel_btns" data-toggle="modal" data-target="#exampleModal"><img src="asset/cancel.png">Disable Student</button>
                        <button class="edit_cont"><img src="{{ asset('School/asset/edit.png') }}">Edit Student</button>
                    </div> -->
                </div>
                <div class="main_tables">
                    <div class="profile_contents">
            ...
            <!-- ...........Add Teacher...... -->
            <div class="hidden step1" id="teacher_view">
                    <div>
                        <ul class="breadcrumb-set">
                        <li><a href="#" class="">Teacher Management</a> /</li>
                        <li><a href="#" class="">Add Teacher</a></li>
                        </ul>
                    </div>
                <div class="set-time-table">
                    <div style="display: flex; gap:10px;">
                        <div class="left_arrows">
                             <img src="{{ asset('School/asset/img/arrow.png') }}" onclick="teacher_view()">
                        </div>
                        <div>
                ...
                <div class="main_tables">
                    ...
                    <div>
                        <button class="continue_btns" onclick="continue_btns()">Continue</button>
                    </div>
                </div>
            </div>
            <!-- ......step2...... -->
            <div class="hidden step2" id="continue_btns">
                    <div>
                        <ul class="breadcrumb-set">
                        <li><a href="#" class="">Teacher Management</a> /</li>
                        <li><a href="#" class="">Add Teacher</a></li>
                ...
                <div class="set-time-table">
                    <div style="display: flex; gap: 10px;">
                        <div class="left_arrows">
                             <img src="{{ asset('School/asset/img/arrow.png') }}" onclick="continue_btns()">
                        </div>
                        <div>
                ...
                <div class="main_tables">
                    <h6 class="personal_conts">Educational Info</h6>
                    <div class="info_titl">
                        <div class="Personal_info_txt">
                            <h4>Qualification</h4>
                            <input type="text" name="" placeholder="20 Mar 2022">
                            <!-- <span class="error">Name</span> -->
                        </div>
                        <div class="Personal_info_txt">
                    ...
                    <div class="info_titl">
                        ...
                        <div class="Personal_info_txt">
                            <h4>School/College/University</h4>
                            <input type="text" name="" placeholder="wille98@gmail.com">
                            <!-- <span class="error">Name</span> -->
                        </div>
                    </div>
                    <div>
                        <button class="continue_btns" onclick="continue_step3()">Continue</button>
                    </div>
                </div>
            </div>
            <!-- ......step3...... -->
            <div class="hidden step3" id="continue_step3">
                      <div>
                        <ul class="breadcrumb-set">
                        <li><a href="#" class="">Teacher Management</a> /</li>
                        <li><a href="#" class="">Add Teacher</a></li>
                ...
                <div class="set-time-table">
                    <div style="display: flex; gap: 10px;">
                         <div class="left_arrows">
                             <img src="{{ asset('School/asset/img/arrow.png') }}" onclick="continue_step3()">
                        </div>
                        <div>
                ...
                <div class="main_tables">
                    ...
                    <div class="" style="width:80%;">
                        <div class="upload_design">
                            <label for="input-file" class="bor_rights">
                                <img src="{{ asset('School/asset/upload.png') }}">
                        ...
                        <div class="Other_conts">
                            ...
                            <div class="btn_sumbit">
                                ...
                                <button class="suff_btn" data-toggle="modal" data-target="#Successfully">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- ........edite..... -->
                  <!-- ...........Add Teacher...... -->
            <div class="hidden step1" id="edit_teacher_view">
                 <div>
                        <ul class="breadcrumb-set">
                ...
                <div class="set-time-table">
                    <div style="display: flex; gap:10px;">
                        <div class="left_arrows">
                             <img src="{{ asset('School/asset/img/arrow.png') }}" onclick="edit_teacher_view()">
                        </div>
                        <div>
                ...
                <div class="main_tables">
                    ...
                    <div>
                        <button class="continue_btns" onclick="continue_btn()">Continue</button>
                    </div>
                </div>
            </div>
            <!-- ......step2...... -->
            <div class="hidden step2" id="continue_btn">
                 <div>
                        <ul class="breadcrumb-set">
                        <li><a href="#" class="">Student Management</a> /</li>
                        <li><a href="#" class="">Eddie Drake</a>/</li>
                ...
                <div class="set-time-table">
                    <div style="display: flex; gap: 10px;">
                        <div class="left_arrows">
                             <img src="{{ asset('School/asset/img/arrow.png') }}" onclick="continue_btn()">
                        </div>
                        <div>
                ...
                <div class="main_tables">
                    ...
                    <div>
                        <button class="continue_btns" onclick="continue_edit()">Continue</button>
                    </div>
                </div>
            </div>
            <!-- ......step3...... -->
            <div class="hidden step3" id="continue_edit">
                  <div>
                        <ul class="breadcrumb-set">
                        <li><a href="#" class="">Student Management</a> /</li>
                        <li><a href="#" class="">Eddie Drake</a>/</li>
                ...
                <div class="set-time-table">
                    ...
                    <div style="display: flex; gap: 10px;">
                         <div class="left_arrows">
                             <img src="{{ asset('School/asset/img/arrow.png') }}" onclick="continue_edit()">
                        </div>
                        <div>
                        ...
                        <div class="upload_design">
                            ...
                            <div class="bor_rights">
                                ...
                                <label for="input-file">
                                       <span class="reload"><img src="asset/re.png">Update Now</span>
                                     <input type="file" id="input-file">
                                </label>
                                  <!-- <span class="error">Name</span> -->
                            </div>
                         <!-- ....2... -->
                            <div class="bor_rights bor_left">
                                ...
                                <span>Birth Certificate *</span>
                                <label for="input-file">
                                       <span class="reload"><img src="a{{ asset('School/sset/re.png') }}">Update Now</span>
                                     <input type="file" id="input-file">
                                </label>
                                  <!-- <span class="error">Name</span> -->
                            </div>
        ...
        <div class="modal-dialog" style="transform: translate(0px, 0%);">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Disable Teacher</h5>
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <div class="satart-cont" style="border:none;">
                        ...
                        <div class="cancel_content">
                                <button class="cancel_btns"><img src="{{ asset('School/asset/icons/delete.svg') }}">Delete Teacher</button>
                            </div> 
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn create_btn" style="background-color: #ff3c30 !important;">Remove</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class=" model_title modal fade" id="map_teacher" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="satart-cont" style="border: none;">
                        ...
                        <div class="set_years" style="padding-top: 30px;">
                            ...
                            <div class="mulite_content">
                                <select class="mySelect for" multiple="multiple" style="width:500px;" placeholder="select"></select>
                            </div>
                        </div>
                    </div>
                </div>
     ...
     <!-- edite Map Teacher -->
    <div class=" model_title modal fade" id="edit_map_teacher" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" >Edit Map Teacher</h5>
                    <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button> -->
                </div>
    ...
    <!--submit -->
    <div class=" model_title modal fade" id="Successfully" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <!-- <h5 class="modal-title" id="exampleModalLabel">Map Teacher</h5> -->
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <div class="successfully_text">
                        ...
                        <h6>Teacher Successfully Onboarded!</h6>
                        <p>Teacher has been successfully onboarded. Now they can login <br>teacher dashboard and manage the class.</p>
                        <button class="Credentials_btn">Send Credentials</button>
                    </div>
                </div>
                <!-- <div class="modal-footer">
                    <button type="button" class="btn cancel_btn" data-dismiss="modal">Cancel</button>
